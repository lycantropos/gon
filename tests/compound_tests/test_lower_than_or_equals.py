...
@given(strategies.compounds_pairs)
def test_connection_with_lower_than(compounds_pair: Tuple[Compound, Compound]
                                    ) -> None:
    first_compound, second_compound = compounds_pair
...
@given(strategies.compounds_pairs)
def test_connection_with_greater_than_or_equals(compounds_pair: Tuple[Compound,
                                                                      Compound]
                                                ) -> None:
    first_compound, second_compound = compounds_pair
