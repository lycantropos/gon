...
class Vector(LinearOriented):
    ...
    def __eq__(self, other: 'Vector') -> bool:
        ...
        >>> vector = Vector.from_raw(((0, 0), (2, 0)))
        >>> vector == vector
        True
        >>> vector == Vector.from_raw(((2, 0), (0, 0)))
        False
        >>> vector == Vector.from_raw(((0, 0), (1, 0)))
        False
        >>> vector == Vector.from_raw(((0, 0), (0, 2)))
        False
        """
        return (self._start == other._start and self._end == other._end
    ...
    def __hash__(self) -> int:
        ...
        True
        >>> hash(vector) == hash(Vector.from_raw(((2, 0), (0, 0))))
        False
        """
    ...
    def raw(self) -> RawVector:
        """
        Returns the vector as combination of Python built-ins.
    ...
    def validate(self) -> None:
        ...
        >>> Vector.from_raw(((0, 0), (2, 0))).validate()
        """
        self._start.validate()
        self._end.validate()
